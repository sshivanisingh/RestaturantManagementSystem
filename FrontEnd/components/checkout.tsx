  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (form.paymentMethod !== "cash") {
        ...
        const { data: payData } = await initiatePayment({ orderId, restaurantId: RESTAURANT_ID })
      ...
      // COD flow
      if (form.paymentMethod === "cash") {
        await confirmCOD({ orderId, restaurantId: RESTAURANT_ID })
        clearCart()
        sessionStorage.removeItem(SESSION_KEY)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="firstName" value={form.firstName}
                      ...
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="Rahul" />
                  </div>
                  <div>
                    <Label htmlFor="lastName">Last Name *</Label>
                    <Input id="lastName" value={form.lastName}
                      onChange={(e) => handleInputChange("lastName", e.target.value)}
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="Kumar" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="email" type="email" value={form.email}
                      ...
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="rahul@email.com" />
                  </div>
                  <div>
                    <Label htmlFor="phone">Phone Number *</Label>
                    <Input id="phone" type="tel" value={form.phone}
                      onChange={(e) => handleInputChange("phone", e.target.value)}
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="9876543210" />
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="city" value={form.city}
                      ...
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="Delhi" />
                  </div>
                  <div>
                    <Label htmlFor="zipCode">Pincode *</Label>
                    <Input id="zipCode" value={form.zipCode}
                      onChange={(e) => handleInputChange("zipCode", e.target.value)}
                      className="border-2 border-gray-200 focus:border-brand-primary mt-1" placeholder="110001" />
                  </div>
                </div>
                <div>
